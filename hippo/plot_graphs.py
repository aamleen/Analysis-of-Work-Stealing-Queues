...
""" def set_plot_save(title, ylab, FF_yaxis, hclib_yaxis):
    ...
    plot_name='hippo_graphs/median/{0}_{1}_Time'.format()
    plt.savefig(plot_name)

    set_plot(title,ylab)
    plotting(0, 'm^--', FF_yaxis,0,10)
    plotting(1, 'bo--', hclib_yaxis,0,10)
    plt.savefig('hippo_graphs/median/{0}_{1}_Time_Zoom') """

FF_filename= "hippoResults/FF_"+benchmark_name+"_"+benchmark_param+"_"  #FF_fib_40_delta_1
...
hclib_filename= "hippoResults/hclib_"+benchmark_name+"_"+benchmark_param+"_"  #hclib_fib_40_1
Hclib_openFile(hclib_filename)

title='FF v/s HClib Time [{0}({1})] Median'.format(benchmark_name,benchmark_param)
...
plot_name='hippo_graphs/median/{0}_{1}_Time'.format(benchmark_name,benchmark_param)
plt.savefig(plot_name)
plt.close(fig)
...
plt.legend(['Fence Free Deq','HCLib Deque'])
plot_name='hippo_graphs/median/{0}_{1}_Time_Zoom.png'.format(benchmark_name,benchmark_param)
plt.savefig(plot_name)
plt.close(fig)

title='FF v/s HClib Steal Ratio [{0}({1})] Median'.format(benchmark_name,benchmark_param)
...
plt.legend(['Fence Free Deq','HCLib Deque'])
plot_name='hippo_graphs/median/{0}_{1}_Steal.png'.format(benchmark_name,benchmark_param)
plt.savefig(plot_name)
plt.close(fig)
...
plt.legend(['Fence Free Deq','HCLib Deque'])
plot_name='hippo_graphs/median/{0}_{1}_Steal_Zoom.png'.format(benchmark_name,benchmark_param)
plt.savefig(plot_name)
plt.close(fig)
print("Plotted to hippo_graphs/median/")